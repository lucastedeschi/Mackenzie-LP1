...
public class BankAccountV2Test {
    ...
    public void testYeld(){
        BankAccountV2 a = new BankAccountV2(0,100);
        a.yield(6.5);
        Assert.assertEquals(106.5, a.getBalance(),0.0);
    }
    @Test
    public void testTransfer(){
        BankAccountV2 a = new BankAccountV2(0,1000);
        BankAccountV2 b = new BankAccountV2(500,0);
        a.transfer(b);
    ...
    public void testGetBalanceNegative(){
        BankAccountV2 a = new BankAccountV2(0,0);
        a.withDraw(100);
    ...
    public void testAccountNumber(){
        BankAccountV2 b = new BankAccountV2(1000, 2500.03);
        Assert.assertEquals(1000, b.getAccountNumber());
        b.setAccountNumber(2000);
        Assert.assertEquals(2000, b.getAccountNumber());
    }
}
